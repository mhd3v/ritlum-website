...
const LED_COLORS = [
  T.habit.blue, T.habit.green, T.habit.yellow,
  T.habit.orange, T.habit.pink, T.habit.cyan, T.habit.purple,
];

// Habits used in app mockups
const HABITS = [
  { id: 'meditate', name: 'Meditate', color: T.habit.blue,   streak: 28, sub: '28-day streak',  done: true,  kind: 'once' },
  { id: 'exercise', name: 'Exercise', color: T.habit.green,  streak: 12, sub: '12-day streak',  done: true,  kind: 'timer' },
  { id: 'read',     name: 'Read',     color: T.habit.orange, streak: 15, sub: '12 / 20 pages',  done: false, kind: 'count', count: '12 / 20' },
  { id: 'hydrate',  name: 'Hydrate',  color: T.habit.pink,   streak: 7,  sub: '3 / 8 glasses',  done: false, kind: 'count', count: '3 / 8' },
  { id: 'journal',  name: 'Journal',  color: T.habit.cyan,   streak: 21, sub: '21-day streak',  done: true,  kind: 'once' },
];
