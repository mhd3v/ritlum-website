# site implementation handoff

This archive is the source of truth for turning the design into production code. Start from `_harness.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `_harness.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `_harness.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `assets/app-stats.png`
- `assets/app-today.png`
- `assets/slices/01-s.png`
- `assets/slices/02-s.png`
- `assets/slices/03-s.png`
- `assets/slices/04-s.png`
- `assets/slices/05-s.png`
- `assets/slices/06-s.png`
- `assets/slices/07-s.png`
- `assets/slices/08-s.png`
- `assets/slices/09-s.png`
- `assets/slices2/01-s.png`
- `assets/slices2/02-s.png`
- `assets/slices2/03-s.png`
- `assets/slices2/04-s.png`
- `assets/slices2/05-s.png`
- `assets/slices2/06-s.png`
- `assets/slices3/01-s.png`
- `assets/slices3/02-s.png`

## Coding checklist for AI tools
1. Inspect `_harness.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
